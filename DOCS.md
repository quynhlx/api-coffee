...
|---------|-----------|--------------------------------------|
| access_token			| String			|  <p>admin access token.</p>							|
| name			| 			|  <p>Food's name.</p>							|
| price			| 			|  <p>Food's price.</p>							|
| pictures			| 			|  <p>Food's pictures.</p>							|
| quantity			| 			|  <p>Food's quantity.</p>							|
| categories			| 			|  <p>Food's categories.</p>							|
